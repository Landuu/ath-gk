...
public class Lab6 extends GLJPanel implements GLEventListener  {
	...
	public void drawObject(GL2 gl2, int corners) {
		...
		for (int i = 1; i <= corners; i++) {
			...
			gl2.glMaterialfv (GL2.GL_FRONT, GL2.GL_AMBIENT_AND_DIFFUSE, material, 0);

			gl2.glVertex3f( 0.0f, 7.5f, 0.0f);
			gl2.glMaterialfv (GL2.GL_FRONT, GL2.GL_AMBIENT_AND_DIFFUSE, material, 4);

			gl2.glVertex3f((float) (radius * Math.cos(angle)), -2.0f,(float) (radius * Math.sin(angle)));
			gl2.glMaterialfv (GL2.GL_FRONT, GL2.GL_AMBIENT_AND_DIFFUSE, material, 8);
